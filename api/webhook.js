// api/webhook.js — Combo Bot v1.0
// Production-hardened: env validation, tgRaw timeout, null-safe callbacks,
// input validation, broadcast chunking, deduped waiting message
